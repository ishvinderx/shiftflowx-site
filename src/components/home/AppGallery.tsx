...
const galleryItems: GalleryItem[] = [
  ...
  },
  {
    ...
    alt: "ShiftFlow AI Insights with ShiftFlow Score and financial snapshot",
    label: "AI Insights",
    accentColor: "#0EA5E9",
  },
  {
  ...
  },
  {
    ...
    alt: "ShiftFlow reports with income trend over time",
    label: "Reports",
    accentColor: "#EC4899",
  },
  {
    src: "/screenshots/invoice.png",
    alt: "ShiftFlow invoice generator for freelancers and contractors",
    label: "Invoices",
    accentColor: "#F97316",
  },
  {
    src: "/screenshots/shifts.png",
    alt: "ShiftFlow shift calendar heatmap",
    label: "Shifts",
    accentColor: "#D63C6B",
  },
  {
    src: "/screenshots/achievements.png",
    alt: "ShiftFlow achievements and consistency streaks",
    label: "Achievements",
    accentColor: "#EAB308",
  },
  {
    src: "/screenshots/profile.png",
    alt: "ShiftFlow profile with financial tools and calculators",
    label: "Tools",
    accentColor: "#8B5CF6",
  },
];
