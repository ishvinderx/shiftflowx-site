...
export const metadata: Metadata = {
  ...
  description: "ShiftFlow helps freelancers track project hours, generate professional invoices, estimate taxes, and manage financial health. Free 30-day trial.",
